...
![Aba "Noções básicas" na criação do Data Factory](images/fig1.png)
...
![Vinculando o repositório Git já na criação da Factory](images/fig2.png)
...
![Configurações de rede e conectividade do runtime de integração](images/fig3.png)
...
![Aba "Marcas" para organizar e classificar o recurso](images/fig4.png)
...
![Revisão de todas as configurações antes da criação](images/fig5.png)
...
![Tela inicial de configuração do repositório, sem Git conectado](images/fig6.png)
...
![Seleção do tipo de repositório (GitHub) e autorização do OAuth](images/fig7.png)
...
![Detalhes da conexão: branches, pasta raiz e importação de recursos](images/fig8.png)
...
![Repositório conectado com sucesso; resumo da configuração](images/fig9.png)
...
![Pipeline com atividades de cópia de dados e notebook, salvo com sucesso](images/fig10.png)
...
![Repositório no GitHub com o histórico de commits do Data Factory](images/fig11.png)
